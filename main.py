...
async def start(client, message):
    ...
    if await check_user_joined_channels(client, user_id, config.REQUIRED_CHANNEL_IDS):
        welcome_message = (
            ...
            "**☞ Rᴇɢɪsᴛᴇʀ Wɪᴛʜ https://www.9999lottery.com/#/register?invitationCode=26437100642**\n\n"
            "**👋 Eᴀʀɴ Dᴀɪʟʏ 2000₹-5000₹ Vɪᴀ Pʟᴀʏɪɴɢ Eᴀsʏ Gᴀᴍᴇs💰**\n\n"
            "**ᴛʜᴀɴᴋ ʏᴏᴜ 😘😘**\n"
            "**────────────────────────────**"
        )
          
        photo_url = "https://telegra.ph/file/f0e7a8100255f1b8f255a.jpg"
        reply_markup = InlineKeyboardMarkup([
            [InlineKeyboardButton("ʀᴇᴄʜᴀʀɢᴇ / ᴡɪᴛʜᴅʀᴀᴡᴀʟ ɪꜱꜱᴜᴇ", url="https://t.me/Agentlottery7")],
            [InlineKeyboardButton("ᴠɪᴘ ᴄʜᴀɴɴᴇʟ", url="https://t.me/+qiSr3YId5w8zMmQ9")],
